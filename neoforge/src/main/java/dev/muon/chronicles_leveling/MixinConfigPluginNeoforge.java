...
public class MixinConfigPluginNeoforge implements IMixinConfigPlugin {
    ...
    private static final Logger LOGGER = LogManager.getLogger("ChroniclesLeveling-Mixin");
    ...
    public void onLoad(String mixinPackage) {
        ...
        // MixinAnnotationAdjusterRegistrar.register(new ChroniclesLevelingMixinCanceller());
    }
